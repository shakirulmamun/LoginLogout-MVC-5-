...
namespace LoginLogout.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        {
            ViewBag.DepartmentId = new SelectList(db.tbl_Department, "DepartmentId", "DepartmentName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,EmployeeName,Salary,Gender,DepartmentId")] tbl_Employee tbl_Employee)
        {
            ...
            ViewBag.DepartmentId = new SelectList(db.tbl_Department, "DepartmentId", "DepartmentName", tbl_Employee.DepartmentId);
            return View(tbl_Employee);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeId,EmployeeName,Salary,Gender,DepartmentId")] tbl_Employee tbl_Employee)
        {
            if (ModelState.IsValid)
            {
